...
<div class="col">
  <div class="row">
    ...
    <p>Os dados do cadastro serão salvos aqui</p>
  </div>
</div>
        ...
        $cep = $rows[$i]['cep'];   
          ...
          echo '<tr class="bg-dark-subtle">
            ...
            <td class="bg-dark-subtle d-flex justify-content-center ">
              <button class="btn btn-light m-1"><a class="d-flex justify-content-center" href="dado.Edi.php?id='.$id.'">
              <lord-icon
              ...
              <button class="btn btn-danger m-1 d-flex jutify-content-center" data-bs-toggle="modal" data-bs-target="#del">
              <lord-icon
  ...
  <div class="modal-dialog">
    ...
    style="width:40px;height:40px">
      ...
      <div class="modal-body">
        <h6>A exsclusão é uma ação permanente.</h6>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Voltar</button>
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">
        <a  href="Dado.E.php?id='.$id.'" class="d-flex justify-content-center text-light " >Exlcuir</a>
        </button>
