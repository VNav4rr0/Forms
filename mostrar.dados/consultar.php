...
edit_note
  ...
  <?php
    ...
    ?>
    <tr>
      <th class="bg-secondary " scope="row"></th>
      ...
      <button type="button" class="btn btn-light d-flex justify-content-around m-1" data-bs-toggle="modal" data-bs-target="#staticBackdrop" >
      <lord-icon
